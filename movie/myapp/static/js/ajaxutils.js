console.log('console working'); // kiểm tra xem file js này có được load hay không

// Xử lý khi click vào nút "Add to Watchlist"
$('#watchbtn').click(() => {
    console.log('click worked'); // kiểm tra xem click đã hoạt động hay chưa

    // Nếu nút đang là "Add to Watchlist" thì thực hiện ajax để thêm vào watchlist
