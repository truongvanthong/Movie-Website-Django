from typing import final # Kiểm tra xem class có được kế thừa hay không
from django.conf import settings # Cấu hình cho ứng dụng
from django.contrib import messages # Thông báo
from django.contrib import auth # Xác thực
from django.contrib.auth import authenticate, login, logout # Xác thực
from django.shortcuts import redirect, render # Chuyển hướng
from .forms import ViewerCreationForm, LoginForm # Form
from django.views import View # Class-based view
from django.core.paginator import Paginator # Phân trang
from .models import Viewer, Movie, ViewerMovie # Model
from django.contrib.auth.forms import AuthenticationForm # Form
from django.http import JsonResponse, request # Trả về dữ liệu dạng json
from django.db.models import Avg
from django.views.decorators.csrf import csrf_exempt # Bỏ qua csrf token
from django.db import connection # Truy vấn sql
import datetime # Thời gian
